--
-- Nouvelles vues/tables Apogée pour l'API V2.
--
...
--drop table SYGAL_ACTEUR_V2;
create table SYGAL_ACTEUR_V2 as select * from V_SYGAL_ACTEUR_V2;
alter table SYGAL_ACTEUR_V2 add source_insert_date date default sysdate;

--drop table SYGAL_DOCTORANT_V2;
create table SYGAL_DOCTORANT_V2 as select * from V_SYGAL_DOCTORANT_V2;
alter table SYGAL_DOCTORANT_V2 add source_insert_date date default sysdate;

--drop table SYGAL_ECOLE_DOCT_V2;
create table SYGAL_ECOLE_DOCT_V2 as select * from V_SYGAL_ECOLE_DOCT_V2;
alter table SYGAL_ECOLE_DOCT_V2 add source_insert_date date default sysdate;

--drop table SYGAL_ETABLISSEMENT_V2;
create table SYGAL_ETABLISSEMENT_V2 as select * from V_SYGAL_ETABLISSEMENT_V2;
alter table SYGAL_ETABLISSEMENT_V2 add source_insert_date date default sysdate;

--drop table SYGAL_FINANCEMENT_V2;
create table SYGAL_FINANCEMENT_V2 as select * from V_SYGAL_FINANCEMENT_V2;
alter table SYGAL_FINANCEMENT_V2 add source_insert_date date default sysdate;

--drop table SYGAL_INDIVIDU_V2;
create table SYGAL_INDIVIDU_V2 as select * from V_SYGAL_INDIVIDU_V2;
alter table SYGAL_INDIVIDU_V2 add source_insert_date date default sysdate;

--drop table SYGAL_ORIGINE_FINANCEMENT_V2;
create table SYGAL_ORIGINE_FINANCEMENT_V2 as select * from V_SYGAL_ORIGINE_FINANCEMENT_V2;
alter table SYGAL_ORIGINE_FINANCEMENT_V2 add source_insert_date date default sysdate;

--drop table SYGAL_ROLE_V2;
create table SYGAL_ROLE_V2 as select * from V_SYGAL_ROLE_V2;
alter table SYGAL_ROLE_V2 add source_insert_date date default sysdate;

--drop table SYGAL_STRUCTURE_V2;
create table SYGAL_STRUCTURE_V2 as select * from V_SYGAL_STRUCTURE_V2;
alter table SYGAL_STRUCTURE_V2 add source_insert_date date default sysdate;

--drop table SYGAL_THESE_V2;
create table SYGAL_THESE_V2 as select * from V_SYGAL_THESE_V2;
alter table SYGAL_THESE_V2 add source_insert_date date default sysdate;

--drop table SYGAL_THESE_ANNEE_UNIV_V2;
create table SYGAL_THESE_ANNEE_UNIV_V2 as select * from V_SYGAL_THESE_ANNEE_UNIV_V2;
alter table SYGAL_THESE_ANNEE_UNIV_V2 add source_insert_date date default sysdate;

--drop table SYGAL_TITRE_ACCES_V2;
create table SYGAL_TITRE_ACCES_V2 as select * from V_SYGAL_TITRE_ACCES_V2;
alter table SYGAL_TITRE_ACCES_V2 add source_insert_date date default sysdate;

--drop table SYGAL_UNITE_RECH_V2;
create table SYGAL_UNITE_RECH_V2 as select * from V_SYGAL_UNITE_RECH_V2;
alter table SYGAL_UNITE_RECH_V2 add source_insert_date date default sysdate;

--drop table SYGAL_VARIABLE_V2;
create table SYGAL_VARIABLE_V2 as select * from V_SYGAL_VARIABLE_V2;
alter table SYGAL_VARIABLE_V2 add source_insert_date date default sysdate;
