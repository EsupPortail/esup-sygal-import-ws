--
-- Nouvelles vues/tables Physalis pour l'API V2.
--
...
CREATE VIEW "API_SCOLARITE"."V_SYGAL_MV_EMAIL_V2" ("LAST_UPDATE", "ID", "EMAIL") AS
...
CREATE VIEW "API_SCOLARITE"."V_SYGAL_ORIGINE_FINANCEMENT_V2" ("ID", "SOURCE_CODE", "SOURCE_ID", "COD_OFI", "LIC_OFI", "LIB_OFI") AS
...
CREATE VIEW "API_SCOLARITE"."V_SYGAL_VARIABLE_V2" ("SOURCE_ID", "SOURCE_CODE", "ID", "COD_VAP", "LIB_VAP", "PAR_VAP", "DATE_DEB_VALIDITE", "DATE_FIN_VALIDITE") AS
select
    'physalis' as source_id,
...
select
    ...
    'assistance-sygal-insa-rouen@normandie-univ.fr' as par_vap,
    to_date('2017-01-01', 'YYYY-MM-DD') as DATE_DEB_VALIDITE,
    to_date('9999-12-31', 'YYYY-MM-DD') as DATE_FIN_VALIDITE
from dual
union all
...
--drop table "API_SCOLARITE".SYGAL_ACTEUR_V2;
create table "API_SCOLARITE".SYGAL_ACTEUR_V2 as select * from "API_SCOLARITE".V_SYGAL_ACTEUR_V2;
alter table "API_SCOLARITE".SYGAL_ACTEUR_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_DOCTORANT_V2;
create table "API_SCOLARITE".SYGAL_DOCTORANT_V2 as select * from "API_SCOLARITE".V_SYGAL_DOCTORANT_V2;
alter table "API_SCOLARITE".SYGAL_DOCTORANT_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_ECOLE_DOCT_V2;
create table "API_SCOLARITE".SYGAL_ECOLE_DOCT_V2 as select * from "API_SCOLARITE".V_SYGAL_ECOLE_DOCT_V2;
alter table "API_SCOLARITE".SYGAL_ECOLE_DOCT_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_ETABLISSEMENT_V2;
create table "API_SCOLARITE".SYGAL_ETABLISSEMENT_V2 as select * from "API_SCOLARITE".V_SYGAL_ETABLISSEMENT_V2;
alter table "API_SCOLARITE".SYGAL_ETABLISSEMENT_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_FINANCEMENT_V2;
create table "API_SCOLARITE".SYGAL_FINANCEMENT_V2 as select * from "API_SCOLARITE".V_SYGAL_FINANCEMENT_V2;
alter table "API_SCOLARITE".SYGAL_FINANCEMENT_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_INDIVIDU_V2;
create table "API_SCOLARITE".SYGAL_INDIVIDU_V2 as select * from "API_SCOLARITE".V_SYGAL_INDIVIDU_V2;
alter table "API_SCOLARITE".SYGAL_INDIVIDU_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_ORIGINE_FINANCEMENT_V2;
create table "API_SCOLARITE".SYGAL_ORIGINE_FINANCEMENT_V2 as select * from "API_SCOLARITE".V_SYGAL_ORIGINE_FINANCEMENT_V2;
alter table "API_SCOLARITE".SYGAL_ORIGINE_FINANCEMENT_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_ROLE_V2;
create table "API_SCOLARITE".SYGAL_ROLE_V2 as select * from "API_SCOLARITE".V_SYGAL_ROLE_V2;
alter table "API_SCOLARITE".SYGAL_ROLE_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_STRUCTURE_V2;
create table "API_SCOLARITE".SYGAL_STRUCTURE_V2 as select * from "API_SCOLARITE".V_SYGAL_STRUCTURE_V2;
alter table "API_SCOLARITE".SYGAL_STRUCTURE_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_THESE_V2;
create table "API_SCOLARITE".SYGAL_THESE_V2 as select * from "API_SCOLARITE".V_SYGAL_THESE_V2;
alter table "API_SCOLARITE".SYGAL_THESE_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_THESE_ANNEE_UNIV_V2;
create table "API_SCOLARITE".SYGAL_THESE_ANNEE_UNIV_V2 as select * from "API_SCOLARITE".V_SYGAL_THESE_ANNEE_UNIV_V2;
alter table "API_SCOLARITE".SYGAL_THESE_ANNEE_UNIV_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_TITRE_ACCES_V2;
create table "API_SCOLARITE".SYGAL_TITRE_ACCES_V2 as select * from "API_SCOLARITE".V_SYGAL_TITRE_ACCES_V2;
alter table "API_SCOLARITE".SYGAL_TITRE_ACCES_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_UNITE_RECH_V2;
create table "API_SCOLARITE".SYGAL_UNITE_RECH_V2 as select * from "API_SCOLARITE".V_SYGAL_UNITE_RECH_V2;
alter table "API_SCOLARITE".SYGAL_UNITE_RECH_V2 add source_insert_date date default sysdate;

--drop table "API_SCOLARITE".SYGAL_VARIABLE_V2;
create table "API_SCOLARITE".SYGAL_VARIABLE_V2 as select * from "API_SCOLARITE".V_SYGAL_VARIABLE_V2;
alter table "API_SCOLARITE".SYGAL_VARIABLE_V2 add source_insert_date date default sysdate;




-- drop VIEW "API_SCOLARITE"."V_SYGAL_ACTEUR_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_DOCTORANT_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_ECOLE_DOCT_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_ETABLISSEMENT_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_FINANCEMENT_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_INDIVIDU_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_MV_EMAIL_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_ORIGINE_FINANCEMENT_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_PHYSALIS_FINANCEMENT_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_ROLE_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_STRUCTURE_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_THESE_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_THESE_ANNEE_UNIV_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_TITRE_ACCES_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_UNITE_RECH_V2";
-- drop VIEW "API_SCOLARITE"."V_SYGAL_VARIABLE_V2";
--
-- drop table "API_SCOLARITE".SYGAL_ACTEUR_V2;
-- drop table "API_SCOLARITE".SYGAL_DOCTORANT_V2;
-- drop table "API_SCOLARITE".SYGAL_ECOLE_DOCT_V2;
